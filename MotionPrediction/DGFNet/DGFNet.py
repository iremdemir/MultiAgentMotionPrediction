...
import math
import numpy as np
from math import gcd # fractions.gcd(a, b) has been moved to the math module in Python 3.9. So just replace the call with math.gcd(a, b)
...
class MLP(nn.Module):
    def __init__(self, input_dim, output_dim, config, p_drop=0.0, hidden_dim=None, residual=False):
